...
contract MetaNomads is ERC721Enumerable, Ownable {
  ...
  uint public maxTotalSupply = 9750;
  SaleConfig public saleConfig;     
  mapping(address => bool) public isWhitelisted;
    
  Counters.Counter private _tokenId;

  constructor() ERC721("Meta Nomads", "NMD") {}
  
  function mintNomad(uint _mintAmount) public payable {
